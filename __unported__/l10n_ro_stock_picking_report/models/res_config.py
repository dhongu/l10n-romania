...
class ResCompany(models.Model):
    ...
    taxes_on_reception = fields.Boolean(
        string="Show taxes on reception report", default=True, help="Show taxes values on reception report"
    )
    banks_on_pickings = fields.Boolean(
        string="Show banks on picking report", default=True, help="Show banks on picking report"
    )
