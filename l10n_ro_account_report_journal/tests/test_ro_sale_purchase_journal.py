...
class TestRoSalePurchaseJournal(InvoiceTestCommon):
    ...
    def setup_company_data(cls, company_name="", **kwargs):
        ...
        company = cls.env["res.company"].create(
            {"name": "Romania test company", "currency_id": cls.env.ref("base.RON").id, **kwargs,}
        )
        ...
        cls.invoices = cls.env["account.move"].create(
            [
                    ...
                    "invoice_line_ids": [
                        (
                            ...
                            None,
                            {
                                ...
                                "quantity": 1,
                                "price_unit": 100,
                                "tax_ids": [(6, 0, [cls.env.ref("l10n_ro.1_tvac_19").id])],
                            },
                        ),
                        (
                            0,
                            None,
                            {
                                ...
                                "quantity": 1,
                                "price_unit": 200,
                                "tax_ids": [(6, 0, [cls.env.ref("l10n_ro.1_tvac_05").id])],
                            },
                        ),
                    ],
                },
                {
                    ...
                    "currency_id": cls.env.ref("base.RON").id,
                    "invoice_line_ids": [
                        (0, None, {"product_id": cls.product_a.id, "quantity": 3, "price_unit": 1000,},),
                        (0, None, {"product_id": cls.product_a.id, "quantity": 1, "price_unit": 3000,},),
                    ],
                },
                {
                    "type": "out_receipt",
                    ...
                    "currency_id": cls.env.ref("base.RON").id,
                    "invoice_line_ids": [
                        (0, None, {"product_id": cls.product_a.id, "quantity": 1, "price_unit": 6000,},),
                    ],
                },
                {
                    "type": "out_refund",
                    ...
                    "currency_id": cls.env.ref("base.RON").id,
                    "invoice_line_ids": [
                        (0, None, {"product_id": cls.product_a.id, "quantity": 1, "price_unit": 1200,},),
                    ],
                },
                {
                    "type": "in_invoice",
                    ...
                    "currency_id": cls.env.ref("base.RON").id,
                    "invoice_line_ids": [
                        (0, None, {"product_id": cls.product_a.id, "quantity": 1, "price_unit": 60,},),
                    ],
                },
                {
                    "type": "in_receipt",
                ...
                },
                {
                    ...
                    "currency_id": cls.env.ref("base.RON").id,
                    "invoice_line_ids": [
                        (0, None, {"product_id": cls.product_a.id, "quantity": 1, "price_unit": 12,},),
                    ],
                },
            ]
        )
    ...
    def assertInvoiceReportValues(self, expected_values_list, journal_type="sale"):
        report_obj = self.env["report.l10n_ro_account_report_journal.report_sale_purchase"]
        self.env["account.move"].search([("company_id", "=", self.env.user.company_id.id)]).post()
        data = {
            "form": {
    ...
    def test_purchase_report(self):
        self.assertInvoiceReportValues(
            [{"no_tag_like_vat0": 60}, {"no_tag_like_vat0": 60}, {"no_tag_like_vat0": -12},], "purchase",
        )
