...
class ResConfigSettings(models.TransientModel):
    ...
    l10n_ro_stock_acc_price_diff = fields.Boolean(related="company_id.l10n_ro_stock_acc_price_diff", readonly=False)
    ...
    module_l10n_ro_payment_receipt_report = fields.Boolean("Romania Payment Receipt Report")
    ...
    module_l10n_ro_stock_picking_valued_report = fields.Boolean("Romanian Stock Picking Valued Report")
    module_l10n_ro_stock_picking_comment_template = fields.Boolean("Romanian Stock Picking Comment Template")
    ...
    def onchange_svl_lot_allocation(self):
        ...
        if (
            ...
            warning += _("The values used for stock out operations will not follow FIFO rule!")
            ...
            if no_tracking_products.exists():
                error = _(
                    "Tracking (Lot/Serial) has to be enabled first " "for all stockable and consumable products !"
                )
    ...
    def default_get(self, fields):
        ...
        res["l10n_ro_stock_account_svl_lot_allocation_visible"] = stock_mod.state == "installed"
        return res
