...
- **Gestiune documente corelate**:
    ...
    - Chitanța tipărită din plată și cea adăugată la finalul facturii folosesc **același șablon** (`report_cash_receipt`): aceeași cutie, aceeași frază, aceeași formatare a identificatorilor și adresei partenerului. Este același document legal, deci trebuie să arate la fel indiferent de unde e tipărit.
...
- Suma în litere pentru RON este formulată de `l10n_ro_report_common` (*cinci sute lei*, nu *Cinci Sute Leu*).
