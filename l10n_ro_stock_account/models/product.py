...
class ProductProduct(models.Model):
    ...
    def _run_fifo(self, quantity, company):
        ...
        candidates = self.env["stock.valuation.layer"].sudo().browse(self._context["origin_return_candidates"])
        ...
        if float_is_zero(qty_to_take_on_candidates, precision_rounding=self.uom_id.rounding):
            ...
            vals_rest = super(ProductProduct, self)._run_fifo(qty_to_take_on_candidates, company)
