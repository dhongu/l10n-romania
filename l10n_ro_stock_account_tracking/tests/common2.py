...
class TestStockCommon2(TestStockCommon):
    ...
    def setUpClass(cls):
        ...
        cls.val_p1_f = round(cls.qty_po_p1 * (cls.price_p1 + cls.price_p1_2 + 2 * cls.diff_p1), 2)
        cls.val_p2_f = round(cls.qty_po_p2 * (cls.price_p2 + cls.price_p2_2 + 2 * cls.diff_p2), 2)
        cls.val_stock_out_so_p1 = round(cls.qty_po_p1 * cls.price_p1 + cls.qty_po_p1 / 2 * cls.price_p1_2, 2)
        cls.val_stock_out_so_p2 = round(cls.qty_po_p2 * cls.price_p2 + cls.qty_po_p2 / 2 * cls.price_p2_2, 2)
