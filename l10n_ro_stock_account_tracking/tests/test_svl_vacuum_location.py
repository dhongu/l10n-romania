...
class TestSVLVacuumLocation(RoTestStockCommon):
    ...
    def test_fifo_negative_location(self):
        ...
        self.assertEqual(sum(move_internal_loc1.stock_valuation_layer_ids.mapped("value")), 0)
        self.assertEqual(sum(move_internal_loc1.stock_valuation_layer_ids.mapped("remaining_qty")), 0)
        self.assertEqual(
        ...
        # account values after vacuum -> credit 371 -> debit 607
        stock_acc_aml = self._get_stock_valuation_move_lines(self.account_valuation_copy)
        ...
        self.assertEqual(stock_acc_aml[3].name, "Revaluation of False (negative inventory)")
        self.assertEqual(sum(move_out_loc1.stock_valuation_layer_ids.mapped("value")), -680.0)
        self.assertEqual(sum(move_out_loc1.stock_valuation_layer_ids.mapped("remaining_qty")), -10.0)
        self.assertEqual(sum(move_out_loc2.stock_valuation_layer_ids.mapped("value")), -160.0)
        self.assertEqual(sum(move_out_loc2.stock_valuation_layer_ids.mapped("remaining_qty")), -20.0)
        ...
        self.assertEqual(sum(move_internal_loc2.stock_valuation_layer_ids.mapped("value")), 0)
        self.assertEqual(
        ...
        self.assertEqual(stock_acc_aml[5].name, "Revaluation of False (negative inventory)")
        self.assertEqual(stock_acc_aml[6].debit, 0)
        self.assertEqual(stock_acc_aml[6].credit, 70)
        self.assertEqual(stock_acc_aml[6].name, "Revaluation of False (negative inventory)")

        self.assertEqual(sum(move_out_loc1.stock_valuation_layer_ids.mapped("value")), -750.0)

        self.assertEqual(sum(move_out_loc1.stock_valuation_layer_ids.mapped("remaining_qty")), 0)
        self.assertEqual(sum(move_out_loc2.stock_valuation_layer_ids.mapped("value")), -230.0)

        self.assertEqual(sum(move_out_loc2.stock_valuation_layer_ids.mapped("remaining_qty")), -10)
        ...
        self.assertEqual(stock_acc_aml[8].name, "Revaluation of False (negative inventory)")

        self.assertEqual(sum(move_out_loc1.stock_valuation_layer_ids.mapped("value")), -750.0)
        self.assertEqual(sum(move_out_loc1.stock_valuation_layer_ids.mapped("remaining_value")), 0)
        self.assertEqual(sum(move_out_loc1.stock_valuation_layer_ids.mapped("remaining_qty")), 0)
        self.assertEqual(sum(move_out_loc2.stock_valuation_layer_ids.mapped("value")), -300)
        self.assertEqual(sum(move_out_loc2.stock_valuation_layer_ids.mapped("remaining_value")), 0)
        self.assertEqual(sum(move_out_loc2.stock_valuation_layer_ids.mapped("remaining_qty")), 0)

        self.assertEqual(sum(move_internal_loc3.stock_valuation_layer_ids.mapped("value")), 0)
        self.assertEqual(
