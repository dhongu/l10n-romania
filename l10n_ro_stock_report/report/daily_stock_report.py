    ...
    def do_compute(self):
        ...
        for product in products:
            ...
            if (
                ...
                and self.location_id.valuation_in_account_id.id not in valuations
            ):
                valuations.append(self.location_id.valuation_in_account_id.id)
            if (
                self.location_id.valuation_out_account_id.id
                and self.location_id.valuation_out_account_id.id not in valuations
            ):
        ...
        if self.mode == "ref":
            ...
            for aml in amls:
                if aml.ref in ref_in:
                    ...
                    ref_in[aml.ref] = {"amount": aml.debit - aml.credit, "aml_ids": [aml.id]}
            ...
            for aml in amls:
                if aml.ref in ref_out:
                    ...
                    ref_out[aml.ref] = {"amount": aml.debit - aml.credit, "aml_ids": [aml.id]}
