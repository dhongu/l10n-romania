...
⚠️ **Prețul de pe bonul de consum este valoarea de stoc a mișcării împărțită la cantitate** — nu vine nici din comanda de vânzare, nici din vreo listă de prețuri. Iar în Odoo 19 mișcările interne nu sunt valorizate, așa că pe un consum din magazie **Preț unitar și Valoare ies 0,00**, ca în captura de mai jos. Nu încercați să „reparați" asta completând o listă de prețuri: nu e citită aici. Documentul rămâne valabil ca dovadă a mișcării cantitative; pentru partea valorică se folosește nota contabilă de descărcare.
...
⚠️ La fel ca la bonul de consum, **coloanele valorice ies 0,00 pe transferurile interne**. Prețul se obține din valoarea mișcării împărțită la cantitate, iar în Odoo 19 mișcările interne nu sunt valorizate (`value` rămâne 0 pentru mișcările care nu intră și nu ies din patrimoniu). Nota de transfer este deci, azi, un document cantitativ.
...
| Bonul de consum sau nota de transfer ies cu **0,00** la Preț unitar și Valoare | Ambele împart valoarea de stoc a mișcării la cantitate, iar în Odoo 19 mișcările interne nu sunt valorizate (`value` rămâne 0) | Comportament curent al modulului, nu o configurare greșită — completarea unei liste de prețuri nu ajută, nu e citită aici. Pentru documente valorice de consum/transfer e nevoie de dezvoltare |
