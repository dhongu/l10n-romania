...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" abstract="true" id="syntax">
  <rule context="$Accounting_supplier_party">
    <assert test="$UBL-SR-42" flag="fatal" id="UBL-SR-42">
  ...
  <rule context="$Additional_supporting_documents">
    <assert test="$UBL-SR-33" flag="fatal" id="UBL-SR-33">
      [UBL-SR-33]-Supporting document description shall occur maximum once
    </assert>
    <assert test="$UBL-SR-43" flag="fatal" id="UBL-SR-43">
  ...
  <rule context="$Invoice">
    ...
    <assert test="$UBL-CR-182" flag="warning" id="UBL-CR-182">
    ...
    <assert test="$UBL-CR-431" flag="warning" id="UBL-CR-431">
    ...
    <assert test="$UBL-DT-19" flag="warning" id="UBL-DT-19">
      [UBL-DT-19]-Language identifier attribute should not be present
    </assert>
    <assert test="$UBL-DT-20" flag="warning" id="UBL-DT-20">
      [UBL-DT-20]-List uri attribute should not be present
    </assert>
    <assert test="$UBL-DT-21" flag="warning" id="UBL-DT-21">
      [UBL-DT-21]-List scheme uri attribute should not be present
    </assert>
    <assert test="$UBL-DT-22" flag="warning" id="UBL-DT-22">
    ...
    <assert test="$UBL-SR-44" flag="fatal" id="UBL-SR-44">
  ...
  <rule context="$Tax_subtotal">
    <assert test="$UBL-SR-32" flag="fatal" id="UBL-SR-32">
