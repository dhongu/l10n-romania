...
<!-- Declaring global variables (in XSLT speak) -->
	...
	<rule context="/ubl:Invoice | /cn:CreditNote">
			...
			<report test="normalize-space(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode) = 'RO' and not(normalize-space(cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity) = $ISO-3166-RO-CODES)"			
				flag="fatal"
				id="BR-RO-110"
				>[BR-RO-110]-Daca Codul ţării vânzătorului (BT-40) este "RO", atunci Subdiviziunea ţării vânzătorului (BT-39) trebuie să fie codificată folosind lista de coduri ISO 3166-2:RO (ex. "RO-B" pentru Municipiul Bucuresti, "RO-AB" pentru judetul Alba...).
	...
	<rule context="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress | /ubl:CreditNote/cac:TaxRepresentativeParty/cac:PostalAddress">
			...
			<report test="normalize-space(cac:Country/cbc:IdentificationCode) = 'RO' and not(normalize-space(cbc:CountrySubentity) = $ISO-3166-RO-CODES)"			
				flag="fatal"
				id="BR-RO-170"
				>[BR-RO-170]-Daca Codul ţării Reprezentantului fiscal al vânzătorului (BT-69) este "RO", atunci Subdiviziunea ţării Reprezentantului fiscal al vânzătorului (BT-68) trebuie să fie codificată folosind lista de coduri ISO 3166-2:RO (ex. "RO-B" pentru Municipiul Bucuresti, "RO-AB" pentru judetul Alba...).
	...
	<rule context="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address | /ubl:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address">
			...
			<report test="normalize-space(cac:Country/cbc:IdentificationCode) = 'RO' and not(normalize-space(cbc:CountrySubentity) = $ISO-3166-RO-CODES)"			
				flag="fatal"
				id="BR-RO-212"
				>[BR-RO-210]-Daca Codul ţării de livrare (BT-80) este "RO", atunci Subdiviziunea ţării de livrare (BT-79) trebuie să fie codificată folosind lista de coduri ISO 3166-2:RO (ex. "RO-B" pentru Municipiul Bucuresti, "RO-AB" pentru judetul Alba...).
